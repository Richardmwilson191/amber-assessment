<div>
                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        ...
                        <div
                            ...
                            <a wire:click.prevent="createCourse"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex">
                                        ...
                                        <a wire:click="assignTeacher({{ $course->id }})"
                                            ...
                                            Assign Teacher</a>
                                        <a wire:click="editCourse({{ $course->id }})"
                ...
                <form wire:submit.prevent="storeCourse">
                    ...
                    <div class="w-full mb-2">
                        <div class="flex flex-col justify-center">
                            ...
                            <input wire:model.defer="course.cost" type="number" placeholder="5000"
    ...
    @if($showAssignTeacher)
        <section class="w-4/5 m-auto mt-12">
            ...
            <div class="px-12 py-16  shadow-lg bg-white lg:w-2/5 m-auto">
                <form wire:submit.prevent="assign({{ $course->id }})">
                    <div class="w-full mb-4">
                        <div class="flex flex-col justify-center">
